...
function startGame() {
  ...
  scoreContainer.innerText = "Puntuación: 0";
...
function showResults() {
  ...
  finalResultContainer.innerText = `Tu puntuación final es ${scoreContainer.innerText.split(": ")[1]} de ${shuffledQuestions.length}`;
